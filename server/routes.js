...
export async function registerRoutes(app, storage) {
    ...
    // Dynamic lab inspection routes
    const dynamicLabInspectionRoutes = await import('./routes/dynamicLabInspections');
    app.use('/api/dynamic-lab-inspections', dynamicLabInspectionRoutes.default);

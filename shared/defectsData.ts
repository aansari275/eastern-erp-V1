// Master defects data for process-specific quality inspections
export interface MasterDefect {
  defectCode: string;
  defectName: string;
  process: string;
  severity: 'Critical' | 'Major' | 'Minor';
  defectClassification: 'CRITICAL' | 'MAJOR' | 'MINOR';
}

export const MASTER_DEFECTS: MasterDefect[] = [
...
export function getDefectsByProcess(process: string): MasterDefect[] {

...
const HomePage: React.FC = () => {
  ...
  const navigationItems = [
    {
      title: 'Sampling',
      description: 'Create and manage rug samples',
      icon: (
    ...
    },
    {
      ...
      description: 'Inspections and compliance management',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              />
              <span className="ml-4 text-xl font-semibold text-gray-900">Eastern ERP</span>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {navigationItems.map((item) => (
            <button
              ...
              className="group relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-200 p-8 text-left"
            >
              <div className={`w-16 h-16 rounded-lg flex items-center justify-center mb-4 ${getColorClasses(item.color)} transition-colors`}>
                {item.icon}
              </div>

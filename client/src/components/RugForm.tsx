...
import { CONSTRUCTION_OPTIONS, ORDER_TYPE_OPTIONS, DYEING_TYPE_OPTIONS, CONSTRUCTION_QUALITY_MAP, PROCESS_NAMES, EDGE_LONGER_SIDE_OPTIONS, EDGE_SHORT_SIDE_OPTIONS, COLOR_PALETTE, Rug, Material, ProcessFlow } from '../types/rug';
...
interface RugFormProps {
  rug?: Rug | null;
  onSave: (rugData: Rug) => Promise<any>;
  onReset: () => void;
  onBack: () => void;
}

const RugForm: React.FC<RugFormProps> = ({ rug, onSave, onReset, onBack }) => {
